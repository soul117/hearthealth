 ...
 */
public class AudioRecorderVisualization implements IAudioRecorder {
    ...
    public AudioRecorderVisualization recordingCallback(RecordingCallback recordingCallback) {
                ...
                try {
                    ...
                    do {
                        ...
                        if (bytesRead > 0) {
                            ...
                            Log.e(AudioRecorderVisualization.class.getSimpleName(), "error: " + bytesRead);
                            onRecordFailure();
                        }
