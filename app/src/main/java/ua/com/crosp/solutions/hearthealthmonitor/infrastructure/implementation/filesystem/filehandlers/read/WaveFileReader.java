package ua.com.crosp.solutions.hearthealthmonitor.infrastructure.implementation.filesystem.filehandlers.read;
...
public class WaveFileReader {
    public static final int PCM_8_BIT = 8;
    public static final int PCM_16_BIT = 16;
        ...
        try {
            ...
            for (int i = 0; i < this.len; ++i) {
                for (int n = 0; n < this.numchannels; ++n) {
                    if (this.bitspersample == PCM_8_BIT) {
                        this.data[n][i] = bis.read();
                    } else if (this.bitspersample == PCM_16_BIT) {
