...
public interface ModeDescriptionPresenterContract extends BasePresenterContract<ModeDescriptionViewContract, ModesRouterContract> {

    void openModeExperiment(ModeListItem modeListItem);

    void openModeSettings(ModeListItem modeListItem);

    void initialize(int modeId);
